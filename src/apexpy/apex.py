...
class Apex(object):
    ...
    The most common methods are :meth:`convert` to convert between all
    supported coordinate systems, and :meth:`map_to_height` to perform
    mapping along a field line to the closest or conjugate hemisphere.

...
!
!  INPUT ARGUMENTS
!    DATAFILE  Name of data file, generated by MAKEAPXSH, containing the
...
!  Must call LOADAPXSH first. All arguments are single precision, except for
!  VECFLAG, which is a 4-byte integers.
!
...
!  Must call LOADAPXSH first. All arguments are single precision, except for
!  MAFLAG and VECFLAG, which are 4-byte integers.
!
